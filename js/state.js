  ...
  applyStateToDOM() {
    ...
    if (site.designSettings) {
      ...
      if (isRgbCards || settings.borderColorGamer === 'rainbow') {
        ...
        css += `
          ${cardsSelectorGamer} {
            background: ${gamerCardBg} !important;
      ...
      if (isRgbCards || settings.borderColorOficina === 'rainbow') {
        ...
        css += `
          ${cardsSelectorOficina} {
            background: ${oficinaCardBg} !important;
            border: 2px solid #ffd700 !important;
            box-shadow: 0 0 15px rgba(212, 175, 55, 0.4) !important;
            animation: none !important;
          }
      ...
      if (settings.gamerModalBgColor) {
        css += `body:not(.light-mode) .modal-content { background: ${settings.gamerModalBgColor} !important; }\n`;
      }
      ...
      if (settings.oficinaModalBgColor) {
        css += `body.light-mode .modal-content { background: ${settings.oficinaModalBgColor} !important; }\n`;
      }
